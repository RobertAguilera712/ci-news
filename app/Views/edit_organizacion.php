<?php 
    $id_directorio = $datos[0]['id_directorio'];
    $descripcion = $datos[0]['descripcion'];
    $estatus = $datos[0]['estatus'];
    $fecha_modificacion = $datos[0]['fecha_modificacion'];
    $link = $datos[0]['link'];
...
<body>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("directoriosAdmin/updateOrganizacion/")?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Editar Organización</h2>
                        <input type="text" id="id_directorio" name="id_directorio" hidden="" 
                            value="<?php echo $id_directorio ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="link"  value="<?php echo $link?>" type="file"
                        ...
                        <center><a class="txt1" href="<?php echo base_url('/directoriosAdmin') ?>">
    ...
    if (mensaje == '1') {
        swal('', 'Fallo al actualizar, seleccione un documento PDF, DOCX, XLSX', 'error');
    } 
    </script>
