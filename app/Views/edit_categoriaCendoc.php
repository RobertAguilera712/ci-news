<?php 
    ...
    $estatus_categoria_cendoc = $datos[0]['estatus_categoria_cendoc'];
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("cendoc/updateCategoriaDocumento/")?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Editar Categoría</h2>
                        <input type="text" id="id_categoria_cendoc" name="id_categoria_cendoc" hidden="" 
                            value="<?php echo $id_categoria_cendoc ?>">
                        <div class="form-group">
                        <label class="col-form-label">Nombre:</label> 
                            <input type="text" class="form-control" name="nombre_categoria_cendoc" id="nombre_categoria_cendoc" value="<?php echo $nombre_categoria_cendoc?>"/>
                        </div>
                        <div class="form-group">
                        <label class="col-form-label">Seleccione el estatus:</label>
                        <select class="form-select form-control" id="estatus_categoria_cendoc" name="estatus_categoria_cendoc">
                        <?php if($estatus_categoria_cendoc =='A'):?>
                            <option selected value="A">Activo</option>
                            <option value="B">Inactivo</option>
                        <?php endif ?>
                        <?php if($estatus_categoria_cendoc == 'B'):?>
