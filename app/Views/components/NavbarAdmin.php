        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo base_url('/cendoc') ?>">Centro documental</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="<?php echo base_url('/banco-datos') ?>">Repositorio de información</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="<?php echo base_url('/banco-datos/browse') ?>">Banco de datos</a></li>
                    </ul>
                </li>
                <?php if ($_SESSION['usuario'] !== 'investigador') : ?>
                    <li class="nav-item dropdown">
