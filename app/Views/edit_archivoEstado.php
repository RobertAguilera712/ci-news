...
<head>
    ...
    <title>Editar Archivo Entidad Federativa</title>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("estados-admin/updateArchivo/")?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Editar Archivo Estado</h2>
                        <input type="text" id="id_archivo" name="id_archivo" hidden="" 
                            value="<?php echo $id_archivo ?>">
                        ...
                        <label class="col-form-label">Seleccione el estado:</label> 
                            <select class="form-select form-control form-input" name="id_estado"  value="<?= $id_estado ?>" required>
                                <option disabled value="<?= $id_estado ?>"  ><?php echo $nombre?></option>
                                <?php foreach($estados as $t):?>
                                    <option value="<?=$t['id_estado'];?>"><?=$t['nombre'];?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <center><a class="txt1" href="<?php echo base_url('/estados-admin') ?>">
