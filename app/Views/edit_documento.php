...
$palabras_clave = $datos[0]['palabras_clave'];
...
$autor_documento = $datos[0]['autor_documento'];
                ...
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("cendoc/updateDoc/") ?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" name="autor_documento" id="autor_documento" value="<?php echo $autor_documento ?>" />
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Palabras clave:</label>
                            <input type="text" class="form-input" name="palabras_clave" id="palabras_clave" value="<?php echo $palabras_clave ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-control form-input" name="id_categoria_cendoc" value="<?= $id_categoria_cendoc ?>" required>
                                ...
                                <?php foreach ($tema as $t) : ?>
                                    <option  <?php echo $t["id_categoria_cendoc"] == $id_categoria_cendoc ? "selected" : ""; ?> value="<?= $t['id_categoria_cendoc']; ?>"><?= $t['nombre_categoria_cendoc']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
