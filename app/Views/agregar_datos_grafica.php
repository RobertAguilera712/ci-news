        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <h2 class="form-title">Agregar Datos a Gráfica</h2>
                    <h4 class="form-title"><?php echo $grafica[0]["titulo"] ?></h4>
                    <h4 class="form-title"><?php echo $grafica[0]["tipo"] ?></h4>
                    <h4 class="form-title"><?php echo $grafica[0]["leyenda_x"] ?></h4>
                    <h4 class="form-title"><?php echo $grafica[0]["leyenda_x"] ?></h4>
                    <h4 class="form-title"><?php echo $grafica[0]["prefijo"] ?></h4>
                    <h4 class="form-title">
                    ...
                    <h4 class="form-title"><?php echo $grafica[0]["fecha_inicio"] ?></h4>
                    <h4 class="form-title"><?php echo $grafica[0]["fecha_fin"] ?></h4>
                    <h4 class="form-title">
                    ...
                    <form method="POST" id="editar" action="<?php echo base_url("graficas-admin/agregarDatosGrafica") ?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <input type="text" id="id_grafica" name="id_grafica" hidden="" value="<?php echo $grafica[0]["id_grafica"] ?>">
                        <input type="text" id="tipo" name="tipo" hidden="" value="<?php echo $grafica[0]["tipo"] ?>">
