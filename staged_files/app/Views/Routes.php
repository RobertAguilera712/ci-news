...
$routes->get('/banco-datos/browse', 'BancoDatos::browseCategories', ['filter' =>  'sessionAdministrador']);
$routes->get('/banco-datos/browse/search', 'BancoDatos::browseDocumentsSearch', ['filter' =>  'sessionAdministrador']);
$routes->get('/banco-datos/browse/categorias/(:any)', 'BancoDatos::browseSubcategories/$1', ['filter' =>  'sessionAdministrador']);
$routes->get('/banco-datos/browse/subcategorias/(:any)', 'BancoDatos::browseDocuments/$1', ['filter' =>  'sessionAdministrador']);
